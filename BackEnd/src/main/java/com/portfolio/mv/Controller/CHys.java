...
import com.portfolio.mv.Entity.hys;
import com.portfolio.mv.Security.Controller.Mensaje;
import com.portfolio.mv.Security.Dto.dtoHys;
import com.portfolio.mv.Service.Shys;
...
public class CHys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        ...
        return new ResponseEntity(new Mensaje("La skill ha sido agregada"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoHys dtohys) {
        ...
        shys.save(hYs);
        return new ResponseEntity(new Mensaje("Se ha actualizado correctamente la skill"), HttpStatus.OK);
    }
